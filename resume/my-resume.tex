...
\item Enhanced the system to be able to track editting ancestry in large multi-file hierarchially structured file system, producing standard \texttt{diff} patch files as well as intuitive side-by-side visualization.
\end{rSubsection}
% %--------------------------------
...
\item Down from scratch Golang implementation of a typical padding oracle attack process. Includes both an authenticated encryption component and the adversary component, all manually implemented down to the integer.
\end{rSubsection}
% %--------------------------------
\end{rSection}
%----------------------------------------------------------------------------------------
